...
import com.open.taogubaweex.component.RichText.MyRich;
import com.open.taogubaweex.component.RichText.MyRichJson;
...
public class WeeXText extends WXComponent<WeeXTextView> {
  ...
  public static class Creator implements ComponentCreator {
    ...
    public WXComponent createInstance(WXSDKInstance instance, WXDomObject node, WXVContainer parent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
      return new WeeXText(instance, node, parent);
    }
  }

  @Deprecated
  public WeeXText(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
    this(instance, dom, parent);
  }

  public WeeXText(WXSDKInstance instance, WXDomObject node,
                WXVContainer parent) {
    super(instance, node, parent);
  }

  @Override
  protected WeeXTextView initComponentHostView(@NonNull Context context) {
    WeeXTextView textView =new WeeXTextView(context);
