...
public class WeeXBaseCircleIndicator extends FrameLayout implements OnPageChangeListener, WXGestureObservable {
  ...
  private WeeXCircleViewPager mCircleViewPager;
  ...
  public WeeXBaseCircleIndicator(Context context) {
    super(context);
    getAttrs(context);
    init();
  }
   ...
   * @param attrs
   */
  public WeeXBaseCircleIndicator(Context context, AttributeSet attrs) {
    super(context, attrs);
    getAttrs(context);
    init();
  }
   ...
   */
  public WeeXCircleViewPager getCircleViewPager() {
   ...
   */
  public void setCircleViewPager(WeeXCircleViewPager mCircleViewPager) {
