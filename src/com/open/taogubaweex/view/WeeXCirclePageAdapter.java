...
public class WeeXCirclePageAdapter extends FragmentPagerAdapter {
	private boolean needLoop = false;
	ArrayList<Fragment> list;  
    public WeeXCirclePageAdapter(FragmentManager fm,ArrayList<Fragment> list) {  
        super(fm);  
        this.list = list;  
    ...
    public int getRealPosition(int shadowPosition) {
      if (shadowPosition < 0 || shadowPosition >= list.size()) {
        return -1;
      } else {
        return getItemIndex(shadowPosition);
      }
    }
  
    public int getFirst() {
      if (needLoop && list.size() > 2) {
        return 1;
      } else {
        return 0;
      }
  ...
  public int getItemIndex(int shadowPosition) {
...
//	public class WeeXCirclePageAdapter extends PagerAdapter {
...
//
//  public WeeXCirclePageAdapter(List<View> views, boolean needLoop) {
//    super();
//    this.views = new ArrayList<>(views);
//    this.needLoop = needLoop;
//  }
//
//  public WeeXCirclePageAdapter() {
//    this(true);
//  }
//
//  public WeeXCirclePageAdapter(boolean needLoop) {
//    super();
//    this.needLoop = needLoop;
//  }
//
