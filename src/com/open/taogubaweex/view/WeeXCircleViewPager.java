...
public class WeeXCircleViewPager extends ViewPager implements WXGestureObservable {
  ...
  @SuppressLint("NewApi")
  public WeeXCircleViewPager(Context context) {
    super(context);
    init();
  }
  ...
  private void init() {
    ...
    addOnPageChangeListener(new OnPageChangeListener() {
      ...
      public void onPageScrollStateChanged(int state) {
        mState = state;
        WeeXCirclePageAdapter adapter = getCirclePageAdapter();
        int currentItemInternal = WeeXCircleViewPager.super.getCurrentItem();
  ...
  @SuppressLint("NewApi")
  public WeeXCircleViewPager(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
   ...
   */
  public WeeXCirclePageAdapter getCirclePageAdapter() {
    return (WeeXCirclePageAdapter) getAdapter();
  }

  /**
   * @param circlePageAdapter the circlePageAdapter to set
   */
  public void setCirclePageAdapter(WeeXCirclePageAdapter circlePageAdapter) {
  ...
  public int getRealCurrentItem() {
    ...
    return ((WeeXCirclePageAdapter) getAdapter()).getRealPosition(i);
  }

  private void setRealCurrentItem(int item) {
    superSetCurrentItem(((WeeXCirclePageAdapter) getAdapter()).getFirst() + item, false);
  }
  ...
  public int getRealCount() {
    return ((WeeXCirclePageAdapter) getAdapter()).getRealCount();
  }
  ...
  private static final class ScrollAction implements Runnable {
    private WeakReference<WeeXCircleViewPager> targetRef;
    private long intervalTime;
    private ScrollAction(WeeXCircleViewPager target, long intervalTime) {
