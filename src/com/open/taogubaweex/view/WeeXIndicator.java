...
public class WeeXIndicator extends WXComponent<WeeXCircleIndicator> {

  @Deprecated
  public WeeXIndicator(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
    this(instance,dom,parent,isLazy);
  }

  public WeeXIndicator(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
    super(instance, dom, parent, isLazy);
  }

  @Override
  protected void setHostLayoutParams(WeeXCircleIndicator host, int width, int height, int left, int right, int top, int bottom) {
  ...
  @Override
  protected WeeXCircleIndicator initComponentHostView(@NonNull Context context) {
    WeeXCircleIndicator view = new WeeXCircleIndicator(context);
    if (getParent() instanceof WeeXSlider) {
      return view;
    } else {
  ...
  @Override
  protected void onHostViewInitialized(WeeXCircleIndicator host) {
    super.onHostViewInitialized(host);
    if (getParent() instanceof WeeXSlider) {
      ((WeeXSlider) getParent()).addIndicator(this);
    }
  }
