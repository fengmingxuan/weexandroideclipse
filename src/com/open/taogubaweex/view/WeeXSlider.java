...
public class WeeXSlider extends WXVContainer<FrameLayout> {
  ...
  public static class Creator implements ComponentCreator {
    public WXComponent createInstance(WXSDKInstance instance, WXDomObject node, WXVContainer parent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
      return new WeeXSlider(instance, node, parent);
    }
  }
   ...
   * package
   **/
  WeeXCircleViewPager mViewPager;
  /**
   * Circle indicator
   */
  protected WeeXIndicator mIndicator;

  /**
   * Adapter for sliderview
   */
  protected WeeXCirclePageAdapter mAdapter;
  ...
  @Deprecated
  public WeeXSlider(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
    this(instance, dom, parent);
  }

  public WeeXSlider(WXSDKInstance instance, WXDomObject node, WXVContainer parent) {
  ...
  protected FrameLayout initComponentHostView(@NonNull Context context) {
    ...
    mViewPager = new WeeXCircleViewPager(context);
    mViewPager.setLayoutParams(pagerParams);

    // init adapter
    mAdapter = new WeeXCirclePageAdapter(((FragmentActivity)context).getSupportFragmentManager(), null);
  ...
  public LayoutParams getChildLayoutParams(WXComponent child,View childView, int width, int height, int left, int right, int top, int bottom) {
    ...
    if (lp instanceof ViewGroup.MarginLayoutParams) {
      //expect indicator .
      if (child instanceof WeeXIndicator) {
  ...
  protected void addSubView(View view, int index) {
    ...
    if (view instanceof WeeXCircleIndicator) {
      return;
    }
...
//    mAdapter.removePageView(child.getHostView());
  ...
  public void addIndicator(WeeXIndicator indicator) {
    FrameLayout root = getHostView();
    if (root == null) {
      return;
    }
    mIndicator = indicator;
    WeeXCircleIndicator indicatorView = indicator.getHostView();
  ...
  protected static class SliderOnScrollListener implements OnPageChangeListener {
    ...
    private WeeXSlider target;

    public SliderOnScrollListener(WeeXSlider target) {
      this.target = target;
